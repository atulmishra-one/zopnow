    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          ...
          <div class="well">
          	<strong>Add New SubCategory </strong>
          </div>
...
<?=$this->session->flashdata('message')?>
          <div class="row-fluid">
             ...
             <div class="table table-bordered">  <br>
              ...
              <form class="form-horizontal" action="<?=base_url()?>admin/subcategory/new_subcategory/<?=@$info[0]['category_id']?>" method="post" id="frm" name="frm">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <select name="category_id" id="category_id">
        ...
        <option value="<?= $cl['category_id']?>" <?=@(!empty($info[0]['category_id']) and $info[0]['category_id'] == $cl['category_id'])? 'selected': ''?>><?= $cl['category_name']?></option>
        <?php endforeach;?>
      </select>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <textarea id="inputEmail" name="subcategory_details" placeholder="Sub Category Details"></textarea>
    </div>
  </div>
  <div class="control-group">
