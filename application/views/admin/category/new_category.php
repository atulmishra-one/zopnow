...
<?=$this->session->flashdata('message')?>
          <div class="row-fluid">
             ...
             <div class="table table-bordered">  <br>
              ...
              <form class="form-horizontal" action="<?=base_url()?>admin/category/new_category" method="post" id="frm" name="frm">
            
  <div class="control-group">
    <label class="control-label" for="inputEmail">Category name</label>
    <div class="controls">
      <input type="text" id="inputEmail" name="category_name" placeholder="Category name (required)">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputEmail">Category Details</label>
    <div class="controls">
      <textarea id="inputEmail" name="category_details" placeholder="Category Details"></textarea>
    </div>
  </div>
  <div class="control-group">
